...
export const VoucherPrintModal: React.FC<VoucherPrintModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-3 overflow-y-auto">
      <div className="relative w-full max-w-3xl bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-200 my-4 text-slate-800 animate-in fade-in zoom-in-95 duration-200">
        {/* Top Controls Toolbar (Hidden when printing) */}
        <div className="no-print flex flex-wrap items-center justify-between gap-3 px-6 py-3.5 bg-slate-900 text-white border-b border-slate-800">
        ...
        {/* ============================================================ */}
        <div
          className="p-8 bg-white border border-slate-100 min-h-[620px] flex flex-col justify-between"
